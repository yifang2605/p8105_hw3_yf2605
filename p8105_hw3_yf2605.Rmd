...
* convert variables: minute_from_midnight, activity_counts as integer
...
* There is one peak of activity on Sunday and one on Friday. 

* On Sundays the activity peak is between 10-11 and on Fridays it is between 20-22.
